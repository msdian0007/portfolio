import{a as u,j as t,r as x}from"./react-8bb107de.js";import{c as q}from"./react-dom-4e24a3e8.js";import{s as i,X as O,L as H}from"./styled-components-ebb5d373.js";import{L as f,B as G}from"./react-router-dom-1657c51e.js";import{F as J,a as C,B as T,M as B,A as b}from"./react-icons-817d4e7e.js";import{T as D}from"./typewriter-effect-bcfdd3b9.js";import{e as F}from"./@emailjs-a704afdc.js";import{S as Y,d as K,a as Q,b as W,c as X,T as k,e as E,f as V,g as U,h as R,i as L,M as Z,C as $,G as _,L as ee}from"./@mui-aa9bc42b.js";import"./@babel-6769ef73.js";import"./scheduler-765c72db.js";import"./react-is-e8e5dbb3.js";import"./@emotion-87a34207.js";import"./hoist-non-react-statics-969199a5.js";import"./react-router-a959c66a.js";import"./@remix-run-ac65ad3c.js";import"./clsx-1229b3e0.js";import"./react-transition-group-e23114ce.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const m of s.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&r(m)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();const te={bg:"#2C3333",bgLight:"#1C1E27",primary:"#2192FF",text_primary:"#F2F3F4",text_secondary:"#b1b2b3",card:"#171721",card_light:"#191924",button:"#854CE6",white:"#FFFFFF",black:"#000000",border:"#FFED00"},ie={bg:"#FFFFFF",bgLight:"#f0f0f0",primary:"#0E8388",text_primary:"#111111",text_secondary:"#48494a",card:"#FFFFFF",button:"#5c5b5b",white:"#FFFFFF"},ae=i.div`
...
`,Ue="/portfolio/assets/HeroImage3-8838643a.jpeg",Re=()=>t.jsx("div",{id:"about",children:t.jsxs(fe,{children:[t.jsx(be,{children:t.jsx(ue,{})}),t.jsxs(ye,{children:[t.jsxs(je,{id:"Left",children:[t.jsxs(ve,{children:["Hi, I am ",t.jsx("br",{})," ",A.name]}),t.jsxs(Ie,{children:["I am a",t.jsx(ke,{children:t.jsx(D,{options:{strings:A.roles,autoStart:!0,loop:!0}})})]}),t.jsx(Ee,{children:A.description}),t.jsx(Ve,{href:A.resume,target:"display",children:"Check Resume"})]}),t.jsx(Se,{id:"Right",children:t.jsx(we,{src:Ue,alt:"hero-image"})})]})]})}),Le=i.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  position: relative;
...
`,Je=i.img`
  width: 24px;
  height: 24px;
`,Ce=()=>{const{getYearOfExperience:e}=M();return t.jsx(Le,{id:"skills",children:t.jsxs(Me,{children:[t.jsx(Pe,{children:"Skills"}),t.jsxs(ze,{children:["Here are some of my skills on which I have been working on for the past ",e(),"."]}),t.jsx(Ne,{children:xe.map((o,a)=>t.jsxs(qe,{children:[t.jsx(Oe,{children:o.title}),t.jsx(He,{children:o.skills.map((r,n)=>t.jsxs(Ge,{children:[t.jsx(Je,{src:r.image}),r.name]},n))})]},a))})]})})},Te=i.div`
...
`,w=({project:e,setOpenModal:o})=>{var a,r;return t.jsxs(Qe,{onClick:()=>o({state:!0,project:e}),children:[t.jsx(We,{src:e.image}),t.jsx(Xe,{children:(a=e.tags)==null?void 0:a.map((n,s)=>t.jsx(Ze,{children:n},s))}),t.jsxs($e,{children:[t.jsx(_e,{children:e.title}),t.jsx(et,{children:e.date}),t.jsx(tt,{children:e.description})]}),t.jsx(it,{children:(r=e.member)==null?void 0:r.map((n,s)=>t.jsx(at,{src:n.img},s))})]})},nt=({openModal:e,setOpenModal:o})=>{const[a,r]=x.useState("all");return t.jsx(Te,{id:"projects",children:t.jsxs(Be,{children:[t.jsx(De,{children:"Projects"}),t.jsx(Fe,{children:"Here are some of my projects."}),t.jsxs(Ye,{children:[a==="all"&&S.map((n,s)=>t.jsx(w,{project:n,openModal:e,setOpenModal:o},s)),S.filter(n=>n.category===a).map((n,s)=>t.jsx(w,{project:n,openModal:e,setOpenModal:o},s))]})]})})},ot=i.div`
display: flex;
flex-direction: column;
justify-content: center;
position: relative;
...
`,lt=i.input`
  ...
  font-size: 18px;
  font-weight: 600;
`,ct=()=>{const[e,o]=u.useState(!1),a=x.useRef(),r=n=>{console.log(a.current),n.preventDefault(),F.sendForm("service_5sj7prw","template_z8nuvrw",a.current,"o71HaDsgKfdgOknGi").then(s=>{o(!0),a.current.reset()},s=>{console.log(s.text)})};return t.jsx(ot,{children:t.jsxs(rt,{children:[t.jsx(st,{children:"Contact"}),t.jsxs(At,{ref:a,onSubmit:r,children:[t.jsx(dt,{children:"Email Me"}),t.jsx(h,{placeholder:"Your Email",name:"from_email",required:!0}),t.jsx(h,{placeholder:"Your Name",name:"from_name",required:!0}),t.jsx(h,{placeholder:"Subject",name:"subject"}),t.jsx(pt,{placeholder:"Message",rows:"4",name:"message",required:!0}),t.jsx(lt,{type:"submit",value:"Send"})]}),t.jsx(Y,{open:e,autoHideDuration:6e3,onClose:()=>o(!1),message:"Email sent successfully!",severity:"success"})]})})},xt=i.div`
  width: 100%;
  padding: 2rem 0;
  display: flex;
  justify-content: center;
...
`,ft=i.p`
  ...
  text-align: center;
`;function bt(){const e=new Date().getFullYear();return t.jsx(xt,{children:t.jsxs(mt,{children:[t.jsx(ht,{children:"Mohasin Attar"}),t.jsxs(gt,{children:[t.jsx(l,{href:"#about",children:"About"}),t.jsx(l,{href:"#skills",children:"Skills"}),t.jsx(l,{href:"#experience",children:"Experience"}),t.jsx(l,{href:"#projects",children:"Projects"}),t.jsx(l,{href:"#education",children:"Education"})]}),t.jsxs(ut,{children:[t.jsx(c,{href:A.linkedin,target:"display",children:t.jsx(K,{})}),t.jsx(c,{href:A.facebook,target:"display",children:t.jsx(Q,{})}),t.jsx(c,{href:A.twitter,target:"display",children:t.jsx(W,{})}),t.jsx(c,{href:A.insta,target:"display",children:t.jsx(X,{})})]}),t.jsxs(ft,{children:["© ",e," Mohasin Attar. All rights reserved."]})]})})}const P=i.img`
    display: none;
    height: 70px;
    width: fit-content;
...
`,Lt=({experience:e})=>{var o;return t.jsxs(jt,{children:[t.jsxs(St,{children:[t.jsx(wt,{src:e.img}),t.jsxs(vt,{children:[t.jsx(It,{children:e.role}),t.jsx(kt,{children:e.company}),t.jsx(Et,{children:e.date})]})]}),t.jsxs(yt,{children:[(e==null?void 0:e.desc)&&t.jsx(z,{children:e==null?void 0:e.desc}),(e==null?void 0:e.skills)&&t.jsxs(t.Fragment,{children:[t.jsx("br",{}),t.jsxs(Vt,{children:[t.jsx("b",{children:"Skills:"}),t.jsx(Ut,{children:(o=e==null?void 0:e.skills)==null?void 0:o.map((a,r)=>t.jsxs(Rt,{children:["• ",a]},r))})]})]})]}),e.doc&&t.jsx("a",{href:e.doc,target:"new",children:t.jsx(P,{src:e.doc})})]})},Mt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`,qt=i.div`
    ...
    justify-content: center;
    gap: 12px;
`,Ot=()=>t.jsx(Mt,{id:"experience",children:t.jsxs(Pt,{children:[t.jsx(zt,{children:"Experience"}),t.jsx(Nt,{children:"My work experience as a MERN Stack Developer and working on different companies and projects."}),t.jsx(qt,{children:t.jsx(k,{children:g.map((e,o)=>t.jsxs(E,{children:[t.jsxs(V,{children:[t.jsx(U,{variant:"outlined",color:"secondary"}),o!==g.length-1&&t.jsx(R,{style:{background:"#854CE6"}})]}),t.jsx(L,{sx:{py:"12px",px:2},children:t.jsx(Lt,{experience:e})})]},o))})})]})}),Ht=i.img`
    display: none;
    height: 70px;
    width: fit-content;
    background-color: #000;
...
`,Qt=({education:e})=>t.jsxs(Jt,{children:[t.jsxs(Ct,{children:[t.jsx(Tt,{src:e.img}),t.jsxs(Bt,{children:[t.jsx(Dt,{children:e.school}),t.jsx(Ft,{children:e.degree}),t.jsx(Yt,{children:e.date})]})]}),t.jsxs(Kt,{children:[t.jsx("b",{children:"Grade: "}),e.grade]}),t.jsx(Gt,{children:t.jsx(N,{children:e.desc})})]}),Wt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`,ei=()=>t.jsx(Wt,{id:"education",children:t.jsxs(Xt,{children:[t.jsx(Zt,{children:"Education"}),t.jsx($t,{children:"Journey Through the Halls of Knowledge: From Aspiring Learner to Accomplished Graduate"}),t.jsx(_t,{children:t.jsx(k,{children:me.map((e,o)=>t.jsxs(E,{children:[t.jsx(L,{sx:{py:"12px",px:2},children:t.jsx(Qt,{education:e})}),t.jsxs(V,{children:[t.jsx(U,{variant:"outlined",color:"secondary"}),o!==g.length&&t.jsx(R,{style:{background:"#854CE6"}})]})]}))})})]})}),ti=i.div`
width: 100%;
height: 100%;
position: absolute;
top: 0;
...
`,hi=({openModal:e,setOpenModal:o})=>{const a=e==null?void 0:e.project;return t.jsx(Z,{open:!0,onClose:()=>o({state:!1,project:null}),children:t.jsx(ti,{children:t.jsxs(ii,{children:[t.jsx($,{style:{position:"absolute",top:"10px",right:"20px",cursor:"pointer"},onClick:()=>o({state:!1,project:null})}),t.jsx(ri,{src:a==null?void 0:a.image}),t.jsx(ai,{children:a==null?void 0:a.title}),t.jsx(ni,{children:a.date}),t.jsx(Ai,{children:a==null?void 0:a.tags.map((r,n)=>t.jsx(di,{children:r},n))}),t.jsx(oi,{children:a==null?void 0:a.description}),a.member&&t.jsxs(t.Fragment,{children:[t.jsx(si,{children:"Members"}),t.jsx(pi,{children:a==null?void 0:a.member.map((r,n)=>t.jsxs(li,{children:[t.jsx(ci,{src:r.img}),t.jsx(xi,{children:r.name}),t.jsx("a",{href:r.github,target:"new",style:{textDecoration:"none",color:"inherit"},children:t.jsx(_,{})}),t.jsx("a",{href:r.linkedin,target:"new",style:{textDecoration:"none",color:"inherit"},children:t.jsx(ee,{})})]},n))})]}),t.jsxs(mi,{children:[t.jsx(v,{dull:!0,href:a==null?void 0:a.github,target:"new",children:"View Code"}),t.jsx(v,{href:a==null?void 0:a.webapp,target:"new",children:"View Live App"})]})]})})})},gi=i.div`
...
`;function ui(){const[e,o]=x.useState(!0),[a,r]=x.useState({state:!1,project:null});return t.jsx(H,{theme:e?te:ie,children:t.jsxs(G,{basename:"/portfolio",children:[t.jsx(he,{setDarkMode:o,darkMode:e}),t.jsxs(gi,{children:[t.jsx(Re,{}),t.jsxs(I,{children:[t.jsx(Ce,{}),t.jsx(Ot,{})]}),t.jsx(nt,{openModal:a,setOpenModal:r}),t.jsxs(I,{children:[t.jsx(ei,{}),t.jsx(ct,{})]}),t.jsx(bt,{}),a.state&&t.jsx(hi,{openModal:a,setOpenModal:r})]})]})})}q.createRoot(document.getElementById("root")).render(t.jsx(u.StrictMode,{children:t.jsx(ui,{})}));
