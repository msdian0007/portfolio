import{a as u,j as t,r as c}from"./react-8bb107de.js";import{c as q}from"./react-dom-4e24a3e8.js";import{s as i,X as z,L as O}from"./styled-components-ebb5d373.js";import{L as f,B as H}from"./react-router-dom-1657c51e.js";import{F as G,a as J,B as C,M as B,A as b}from"./react-icons-817d4e7e.js";import{T}from"./typewriter-effect-bcfdd3b9.js";import{e as F}from"./@emailjs-a704afdc.js";import{S as D,d as K,a as W,b as Q,c as Y,T as k,e as V,f as E,g as U,h as R,i as L,M as X,C as Z,G as $,L as _}from"./@mui-aa9bc42b.js";import"./@babel-6769ef73.js";import"./scheduler-765c72db.js";import"./react-is-e8e5dbb3.js";import"./@emotion-87a34207.js";import"./hoist-non-react-statics-969199a5.js";import"./react-router-a959c66a.js";import"./@remix-run-ac65ad3c.js";import"./clsx-1229b3e0.js";import"./react-transition-group-e23114ce.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const m of s.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&r(m)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const ee={bg:"#2C3333",bgLight:"#1C1E27",primary:"#2192FF",text_primary:"#F2F3F4",text_secondary:"#b1b2b3",card:"#171721",card_light:"#191924",button:"#854CE6",white:"#FFFFFF",black:"#000000",border:"#FFED00"},te={bg:"#FFFFFF",bgLight:"#f0f0f0",primary:"#0E8388",text_primary:"#111111",text_secondary:"#48494a",card:"#FFFFFF",button:"#5c5b5b",white:"#FFFFFF"},ie=i.div`
...
`,Ve="/portfolio/assets/HeroImage3-8838643a.jpeg",Ee=()=>t.jsx("div",{id:"about",children:t.jsxs(ge,{children:[t.jsx(ue,{children:t.jsx(he,{})}),t.jsxs(fe,{children:[t.jsxs(be,{id:"Left",children:[t.jsxs(Se,{children:["Hi, I am ",t.jsx("br",{})," ",A.name]}),t.jsxs(we,{children:["I am a",t.jsx(ve,{children:t.jsx(T,{options:{strings:A.roles,autoStart:!0,loop:!0}})})]}),t.jsx(Ie,{children:A.description}),t.jsx(ke,{href:A.resume,target:"display",children:"Check Resume"})]}),t.jsx(ye,{id:"Right",children:t.jsx(je,{src:Ve,alt:"hero-image"})})]})]})}),Ue=i.div`
display: flex;
flex-direction: column;
justify-content: center;
position: relative;
...
`,w=({project:e,setOpenModal:n})=>{var a,r;return t.jsxs(Ke,{onClick:()=>n({state:!0,project:e}),children:[t.jsx(We,{src:e.image}),t.jsx(Qe,{children:(a=e.tags)==null?void 0:a.map((o,s)=>t.jsx(Ye,{children:o},s))}),t.jsxs(Xe,{children:[t.jsx(Ze,{children:e.title}),t.jsx($e,{children:e.date}),t.jsx(_e,{children:e.description})]}),t.jsx(et,{children:(r=e.member)==null?void 0:r.map((o,s)=>t.jsx(tt,{src:o.img},s))})]})},it=({openModal:e,setOpenModal:n})=>{const[a,r]=c.useState("all");return t.jsx(Je,{id:"projects",children:t.jsxs(Ce,{children:[t.jsx(Be,{children:"Projects"}),t.jsx(Te,{children:"Here are some of my projects."}),t.jsxs(Fe,{children:[a==="all"&&S.map((o,s)=>t.jsx(w,{project:o,openModal:e,setOpenModal:n},s)),S.filter(o=>o.category===a).map((o,s)=>t.jsx(w,{project:o,openModal:e,setOpenModal:n},s))]})]})})},at=i.div`
display: flex;
flex-direction: column;
justify-content: center;
position: relative;
...
`,gt=i.p`
  ...
  text-align: center;
`;function ut(){return t.jsx(lt,{children:t.jsxs(xt,{children:[t.jsx(ct,{children:"Mohasin Attar"}),t.jsxs(mt,{children:[t.jsx(l,{href:"#about",children:"About"}),t.jsx(l,{href:"#skills",children:"Skills"}),t.jsx(l,{href:"#experience",children:"Experience"}),t.jsx(l,{href:"#projects",children:"Projects"}),t.jsx(l,{href:"#education",children:"Education"})]}),t.jsxs(ht,{children:[t.jsx(x,{href:A.linkedin,target:"display",children:t.jsx(K,{})}),t.jsx(x,{href:A.facebook,target:"display",children:t.jsx(W,{})}),t.jsx(x,{href:A.twitter,target:"display",children:t.jsx(Q,{})}),t.jsx(x,{href:A.insta,target:"display",children:t.jsx(Y,{})})]}),t.jsx(gt,{children:"© 2023 Mohasin Attar. All rights reserved."})]})})}const P=i.img`
    display: none;
    height: 70px;
    width: fit-content;
...
`,Ut=({experience:e})=>{var n;return t.jsxs(bt,{children:[t.jsxs(yt,{children:[t.jsx(jt,{src:e.img}),t.jsxs(St,{children:[t.jsx(wt,{children:e.role}),t.jsx(vt,{children:e.company}),t.jsx(It,{children:e.date})]})]}),t.jsxs(ft,{children:[(e==null?void 0:e.desc)&&t.jsx(N,{children:e==null?void 0:e.desc}),(e==null?void 0:e.skills)&&t.jsxs(t.Fragment,{children:[t.jsx("br",{}),t.jsxs(kt,{children:[t.jsx("b",{children:"Skills:"}),t.jsx(Vt,{children:(n=e==null?void 0:e.skills)==null?void 0:n.map((a,r)=>t.jsxs(Et,{children:["• ",a]},r))})]})]})]}),e.doc&&t.jsx("a",{href:e.doc,target:"new",children:t.jsx(P,{src:e.doc})})]})},Rt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`,Mt=i.div`
    ...
    justify-content: center;
    gap: 12px;
`,qt=()=>t.jsx(Rt,{id:"experience",children:t.jsxs(Lt,{children:[t.jsx(Pt,{children:"Experience"}),t.jsx(Nt,{children:"My work experience as a web developer and working on different companies and projects."}),t.jsx(Mt,{children:t.jsx(k,{children:g.map((e,n)=>t.jsxs(V,{children:[t.jsxs(E,{children:[t.jsx(U,{variant:"outlined",color:"secondary"}),n!==g.length-1&&t.jsx(R,{style:{background:"#854CE6"}})]}),t.jsx(L,{sx:{py:"12px",px:2},children:t.jsx(Ut,{experience:e})})]},n))})})]})}),zt=i.img`
    display: none;
    height: 70px;
    width: fit-content;
    background-color: #000;
...
`,Kt=({education:e})=>t.jsxs(Ht,{children:[t.jsxs(Gt,{children:[t.jsx(Jt,{src:e.img}),t.jsxs(Ct,{children:[t.jsx(Bt,{children:e.school}),t.jsx(Tt,{children:e.degree}),t.jsx(Ft,{children:e.date})]})]}),t.jsxs(Dt,{children:[t.jsx("b",{children:"Grade: "}),e.grade]}),t.jsx(Ot,{children:t.jsx(M,{children:e.desc})})]}),Wt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`,$t=()=>t.jsx(Wt,{id:"education",children:t.jsxs(Qt,{children:[t.jsx(Yt,{children:"Education"}),t.jsx(Xt,{children:"Journey Through the Halls of Knowledge: From Aspiring Learner to Accomplished Graduate"}),t.jsx(Zt,{children:t.jsx(k,{children:xe.map((e,n)=>t.jsxs(V,{children:[t.jsx(L,{sx:{py:"12px",px:2},children:t.jsx(Kt,{education:e})}),t.jsxs(E,{children:[t.jsx(U,{variant:"outlined",color:"secondary"}),n!==g.length&&t.jsx(R,{style:{background:"#854CE6"}})]})]}))})})]})}),_t=i.div`
width: 100%;
height: 100%;
position: absolute;
top: 0;
...
`;function hi(){const[e,n]=c.useState(!0),[a,r]=c.useState({state:!1,project:null});return t.jsx(O,{theme:e?ee:te,children:t.jsxs(H,{basename:"/portfolio",children:[t.jsx(ce,{setDarkMode:n,darkMode:e}),t.jsxs(mi,{children:[t.jsx(Ee,{}),t.jsxs(I,{children:[t.jsx(Ge,{}),t.jsx(qt,{})]}),t.jsx(it,{openModal:a,setOpenModal:r}),t.jsxs(I,{children:[t.jsx($t,{}),t.jsx(pt,{})]}),t.jsx(ut,{}),a.state&&t.jsx(ci,{openModal:a,setOpenModal:r})]})]})})}q.createRoot(document.getElementById("root")).render(t.jsx(u.StrictMode,{children:t.jsx(hi,{})}));
