...
`,Wt=({education:e})=>t.jsxs(Ht,{children:[t.jsxs(Gt,{children:[t.jsx(Jt,{src:e.img}),t.jsxs(Ct,{children:[t.jsx(Bt,{children:e.school}),t.jsx(Tt,{children:e.degree}),t.jsx(Ft,{children:e.date})]})]}),t.jsxs(Dt,{children:[t.jsx("b",{children:"Grade: "}),e.grade]}),t.jsx(Ot,{children:t.jsx(q,{children:e.desc})})]}),Yt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
