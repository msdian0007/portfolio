...
`,Ut=({experience:e})=>{var n;return t.jsxs(bt,{children:[t.jsxs(yt,{children:[t.jsx(jt,{src:e.img}),t.jsxs(St,{children:[t.jsx(wt,{children:e.role}),t.jsx(vt,{children:e.company}),t.jsx(It,{children:e.date})]})]}),t.jsxs(ft,{children:[(e==null?void 0:e.desc)&&t.jsx(q,{children:e==null?void 0:e.desc}),(e==null?void 0:e.skills)&&t.jsxs(t.Fragment,{children:[t.jsx("br",{}),t.jsxs(kt,{children:[t.jsx("b",{children:"Skills:"}),t.jsx(Vt,{children:(n=e==null?void 0:e.skills)==null?void 0:n.map((a,r)=>t.jsxs(Et,{children:["• ",a]},r))})]})]})]}),e.doc&&t.jsx("a",{href:e.doc,target:"new",children:t.jsx(P,{src:e.doc})})]})},Rt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`,zt=i.div`
    ...
    justify-content: center;
    gap: 12px;
`,Nt=()=>t.jsx(Rt,{id:"experience",children:t.jsxs(Lt,{children:[t.jsx(Pt,{children:"Experience"}),t.jsx(qt,{children:"My work experience as a web developer and working on different companies and projects."}),t.jsx(zt,{children:t.jsx(k,{children:g.map((e,n)=>t.jsxs(V,{children:[t.jsxs(E,{children:[t.jsx(U,{variant:"outlined",color:"secondary"}),n!==g.length-1&&t.jsx(R,{style:{background:"#854CE6"}})]}),t.jsx(L,{sx:{py:"12px",px:2},children:t.jsx(Ut,{experience:e})})]},n))})})]})}),Mt=i.img`
    display: none;
    height: 70px;
    width: fit-content;
    background-color: #000;
...
`,Kt=({education:e})=>t.jsxs(Ht,{children:[t.jsxs(Gt,{children:[t.jsx(Jt,{src:e.img}),t.jsxs(Ct,{children:[t.jsx(Bt,{children:e.school}),t.jsx(Tt,{children:e.degree}),t.jsx(Ft,{children:e.date})]})]}),t.jsxs(Dt,{children:[t.jsx("b",{children:"Grade: "}),e.grade]}),t.jsx(Ot,{children:t.jsx(z,{children:e.desc})})]}),Wt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`;function hi(){const[e,n]=c.useState(!0),[a,r]=c.useState({state:!1,project:null});return t.jsx(O,{theme:e?ee:te,children:t.jsxs(H,{basename:"/portfolio",children:[t.jsx(ce,{setDarkMode:n,darkMode:e}),t.jsxs(mi,{children:[t.jsx(Ee,{}),t.jsxs(I,{children:[t.jsx(Ge,{}),t.jsx(Nt,{})]}),t.jsx(it,{openModal:a,setOpenModal:r}),t.jsxs(I,{children:[t.jsx($t,{}),t.jsx(pt,{})]}),t.jsx(ut,{}),a.state&&t.jsx(ci,{openModal:a,setOpenModal:r})]})]})})}N.createRoot(document.getElementById("root")).render(t.jsx(u.StrictMode,{children:t.jsx(hi,{})}));
