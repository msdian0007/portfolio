import{a as u,j as t,r as x}from"./react-8bb107de.js";import{c as z}from"./react-dom-4e24a3e8.js";import{s as i,X as q,L as O}from"./styled-components-ebb5d373.js";import{L as f,B as H}from"./react-router-dom-1657c51e.js";import{F as G,a as J,B as C,M as T,A as b}from"./react-icons-817d4e7e.js";import{T as B}from"./typewriter-effect-bcfdd3b9.js";import{e as D}from"./@emailjs-a704afdc.js";import{S as F,d as K,a as Y,b as Q,c as W,T as k,e as V,f as E,g as U,h as R,i as L,M as X,C as Z,G as $,L as _}from"./@mui-aa9bc42b.js";import"./@babel-6769ef73.js";import"./scheduler-765c72db.js";import"./react-is-e8e5dbb3.js";import"./@emotion-87a34207.js";import"./hoist-non-react-statics-969199a5.js";import"./react-router-a959c66a.js";import"./@remix-run-ac65ad3c.js";import"./clsx-1229b3e0.js";import"./react-transition-group-e23114ce.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const m of s.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&r(m)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const ee={bg:"#2C3333",bgLight:"#1C1E27",primary:"#2192FF",text_primary:"#F2F3F4",text_secondary:"#b1b2b3",card:"#171721",card_light:"#191924",button:"#854CE6",white:"#FFFFFF",black:"#000000",border:"#FFED00"},te={bg:"#FFFFFF",bgLight:"#f0f0f0",primary:"#0E8388",text_primary:"#111111",text_secondary:"#48494a",card:"#FFFFFF",button:"#5c5b5b",white:"#FFFFFF"},ie=i.div`
...
`,Ve="/portfolio/assets/HeroImage3-8838643a.jpeg",Ee=()=>t.jsx("div",{id:"about",children:t.jsxs(ge,{children:[t.jsx(ue,{children:t.jsx(he,{})}),t.jsxs(fe,{children:[t.jsxs(be,{id:"Left",children:[t.jsxs(Se,{children:["Hi, I am ",t.jsx("br",{})," ",A.name]}),t.jsxs(we,{children:["I am a",t.jsx(ve,{children:t.jsx(B,{options:{strings:A.roles,autoStart:!0,loop:!0}})})]}),t.jsx(Ie,{children:A.description}),t.jsx(ke,{href:A.resume,target:"display",children:"Check Resume"})]}),t.jsx(ye,{id:"Right",children:t.jsx(je,{src:Ve,alt:"hero-image"})})]})]})}),Ue=i.div`
display: flex;
flex-direction: column;
justify-content: center;
position: relative;
...
`,w=({project:e,setOpenModal:n})=>{var a,r;return t.jsxs(Ke,{onClick:()=>n({state:!0,project:e}),children:[t.jsx(Ye,{src:e.image}),t.jsx(Qe,{children:(a=e.tags)==null?void 0:a.map((o,s)=>t.jsx(We,{children:o},s))}),t.jsxs(Xe,{children:[t.jsx(Ze,{children:e.title}),t.jsx($e,{children:e.date}),t.jsx(_e,{children:e.description})]}),t.jsx(et,{children:(r=e.member)==null?void 0:r.map((o,s)=>t.jsx(tt,{src:o.img},s))})]})},it=({openModal:e,setOpenModal:n})=>{const[a,r]=x.useState("all");return t.jsx(Je,{id:"projects",children:t.jsxs(Ce,{children:[t.jsx(Te,{children:"Projects"}),t.jsx(Be,{children:"Here are some of my projects."}),t.jsxs(De,{children:[a==="all"&&S.map((o,s)=>t.jsx(w,{project:o,openModal:e,setOpenModal:n},s)),S.filter(o=>o.category===a).map((o,s)=>t.jsx(w,{project:o,openModal:e,setOpenModal:n},s))]})]})})},at=i.div`
display: flex;
flex-direction: column;
justify-content: center;
position: relative;
...
`,dt=i.input`
  ...
  font-size: 18px;
  font-weight: 600;
`,pt=()=>{const[e,n]=u.useState(!1),a=x.useRef(),r=o=>{console.log(a.current),o.preventDefault(),D.sendForm("service_5sj7prw","template_z8nuvrw",a.current,"o71HaDsgKfdgOknGi").then(s=>{n(!0),a.current.reset()},s=>{console.log(s.text)})};return t.jsx(at,{children:t.jsxs(nt,{children:[t.jsx(ot,{children:"Contact"}),t.jsxs(rt,{ref:a,onSubmit:r,children:[t.jsx(st,{children:"Email Me"}),t.jsx(h,{placeholder:"Your Email",name:"from_email",required:!0}),t.jsx(h,{placeholder:"Your Name",name:"from_name",required:!0}),t.jsx(h,{placeholder:"Subject",name:"subject"}),t.jsx(At,{placeholder:"Message",rows:"4",name:"message",required:!0}),t.jsx(dt,{type:"submit",value:"Send"})]}),t.jsx(F,{open:e,autoHideDuration:6e3,onClose:()=>n(!1),message:"Email sent successfully!",severity:"success"})]})})},lt=i.div`
  width: 100%;
  padding: 2rem 0;
  display: flex;
  justify-content: center;
...
`,gt=i.p`
  ...
  text-align: center;
`;function ut(){const e=new Date().getFullYear();return t.jsx(lt,{children:t.jsxs(ct,{children:[t.jsx(xt,{children:"Mohasin Attar"}),t.jsxs(mt,{children:[t.jsx(l,{href:"#about",children:"About"}),t.jsx(l,{href:"#skills",children:"Skills"}),t.jsx(l,{href:"#experience",children:"Experience"}),t.jsx(l,{href:"#projects",children:"Projects"}),t.jsx(l,{href:"#education",children:"Education"})]}),t.jsxs(ht,{children:[t.jsx(c,{href:A.linkedin,target:"display",children:t.jsx(K,{})}),t.jsx(c,{href:A.facebook,target:"display",children:t.jsx(Y,{})}),t.jsx(c,{href:A.twitter,target:"display",children:t.jsx(Q,{})}),t.jsx(c,{href:A.insta,target:"display",children:t.jsx(W,{})})]}),t.jsxs(gt,{children:["© ",e," Mohasin Attar. All rights reserved."]})]})})}const P=i.img`
    display: none;
    height: 70px;
    width: fit-content;
...
`,Ut=({experience:e})=>{var n;return t.jsxs(bt,{children:[t.jsxs(yt,{children:[t.jsx(jt,{src:e.img}),t.jsxs(St,{children:[t.jsx(wt,{children:e.role}),t.jsx(vt,{children:e.company}),t.jsx(It,{children:e.date})]})]}),t.jsxs(ft,{children:[(e==null?void 0:e.desc)&&t.jsx(M,{children:e==null?void 0:e.desc}),(e==null?void 0:e.skills)&&t.jsxs(t.Fragment,{children:[t.jsx("br",{}),t.jsxs(kt,{children:[t.jsx("b",{children:"Skills:"}),t.jsx(Vt,{children:(n=e==null?void 0:e.skills)==null?void 0:n.map((a,r)=>t.jsxs(Et,{children:["• ",a]},r))})]})]})]}),e.doc&&t.jsx("a",{href:e.doc,target:"new",children:t.jsx(P,{src:e.doc})})]})},Rt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`,Nt=i.div`
    ...
    justify-content: center;
    gap: 12px;
`,zt=()=>t.jsx(Rt,{id:"experience",children:t.jsxs(Lt,{children:[t.jsx(Pt,{children:"Experience"}),t.jsx(Mt,{children:"My work experience as a MERN Stack Developer and working on different companies and projects."}),t.jsx(Nt,{children:t.jsx(k,{children:g.map((e,n)=>t.jsxs(V,{children:[t.jsxs(E,{children:[t.jsx(U,{variant:"outlined",color:"secondary"}),n!==g.length-1&&t.jsx(R,{style:{background:"#854CE6"}})]}),t.jsx(L,{sx:{py:"12px",px:2},children:t.jsx(Ut,{experience:e})})]},n))})})]})}),qt=i.img`
    display: none;
    height: 70px;
    width: fit-content;
    background-color: #000;
...
`,Kt=({education:e})=>t.jsxs(Ht,{children:[t.jsxs(Gt,{children:[t.jsx(Jt,{src:e.img}),t.jsxs(Ct,{children:[t.jsx(Tt,{children:e.school}),t.jsx(Bt,{children:e.degree}),t.jsx(Dt,{children:e.date})]})]}),t.jsxs(Ft,{children:[t.jsx("b",{children:"Grade: "}),e.grade]}),t.jsx(Ot,{children:t.jsx(N,{children:e.desc})})]}),Yt=i.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    position: relative;
...
`,$t=()=>t.jsx(Yt,{id:"education",children:t.jsxs(Qt,{children:[t.jsx(Wt,{children:"Education"}),t.jsx(Xt,{children:"Journey Through the Halls of Knowledge: From Aspiring Learner to Accomplished Graduate"}),t.jsx(Zt,{children:t.jsx(k,{children:ce.map((e,n)=>t.jsxs(V,{children:[t.jsx(L,{sx:{py:"12px",px:2},children:t.jsx(Kt,{education:e})}),t.jsxs(E,{children:[t.jsx(U,{variant:"outlined",color:"secondary"}),n!==g.length&&t.jsx(R,{style:{background:"#854CE6"}})]})]}))})})]})}),_t=i.div`
width: 100%;
height: 100%;
position: absolute;
top: 0;
...
`,xi=({openModal:e,setOpenModal:n})=>{const a=e==null?void 0:e.project;return t.jsx(X,{open:!0,onClose:()=>n({state:!1,project:null}),children:t.jsx(_t,{children:t.jsxs(ei,{children:[t.jsx(Z,{style:{position:"absolute",top:"10px",right:"20px",cursor:"pointer"},onClick:()=>n({state:!1,project:null})}),t.jsx(ni,{src:a==null?void 0:a.image}),t.jsx(ti,{children:a==null?void 0:a.title}),t.jsx(ii,{children:a.date}),t.jsx(ri,{children:a==null?void 0:a.tags.map((r,o)=>t.jsx(si,{children:r},o))}),t.jsx(ai,{children:a==null?void 0:a.description}),a.member&&t.jsxs(t.Fragment,{children:[t.jsx(oi,{children:"Members"}),t.jsx(Ai,{children:a==null?void 0:a.member.map((r,o)=>t.jsxs(di,{children:[t.jsx(pi,{src:r.img}),t.jsx(li,{children:r.name}),t.jsx("a",{href:r.github,target:"new",style:{textDecoration:"none",color:"inherit"},children:t.jsx($,{})}),t.jsx("a",{href:r.linkedin,target:"new",style:{textDecoration:"none",color:"inherit"},children:t.jsx(_,{})})]},o))})]}),t.jsxs(ci,{children:[t.jsx(v,{dull:!0,href:a==null?void 0:a.github,target:"new",children:"View Code"}),t.jsx(v,{href:a==null?void 0:a.webapp,target:"new",children:"View Live App"})]})]})})})},mi=i.div`
...
`;function hi(){const[e,n]=x.useState(!0),[a,r]=x.useState({state:!1,project:null});return t.jsx(O,{theme:e?ee:te,children:t.jsxs(H,{basename:"/portfolio",children:[t.jsx(xe,{setDarkMode:n,darkMode:e}),t.jsxs(mi,{children:[t.jsx(Ee,{}),t.jsxs(I,{children:[t.jsx(Ge,{}),t.jsx(zt,{})]}),t.jsx(it,{openModal:a,setOpenModal:r}),t.jsxs(I,{children:[t.jsx($t,{}),t.jsx(pt,{})]}),t.jsx(ut,{}),a.state&&t.jsx(xi,{openModal:a,setOpenModal:r})]})]})})}z.createRoot(document.getElementById("root")).render(t.jsx(u.StrictMode,{children:t.jsx(hi,{})}));
